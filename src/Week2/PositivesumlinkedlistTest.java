...
class PositivesumlinkedlistTest {
        ...
        void test1() {
            ...
            arr[0]=Positivesumlinkedlist.merge(arr, k);
            arr[0]=Positivesumlinkedlist.sort(arr[0]);
            String result=Positivesumlinkedlist.display(arr[0]);
